...
MATERIALS: dict[str, Material] = {
    ...
    "frp_eglass": Material(
        ...
        "E-glass 적층 C급 — ISO/DIS 12215-5.3(2004 초안, NMMA "
        "호스팅) 프레임 확인: σ_d=0.5·σ_uf, 물성=f(유리질량비 ψ). "
        "손적층 CSM ψ0.30 σ_uf~134·σ_d~67·E~6400 / WR ψ0.48 "
        "E~13240. 현 σ_d 100·E 15000은 WR급 함의·약간 낙관. "
        "2019 정본(오너 KS 캡처)·미사용 재료라 값 보류·초안 각주만"),
}
