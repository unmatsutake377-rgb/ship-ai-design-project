...
> (마지막 갱신: 2026-08-09 — 22일차: 일곱 번째 관문 "돌라면 도나" — 7중 게이트 완성)
...
| ③ 물리 검증 | ✅ **7중 게이트** (무게·공간·균형·트림 + 내항 + 구조 "부러지나" + **조종 "돌라면 도나"**) + 저항 3체계 + 실물 추진계·방향타 |
...
**참고 숫자** (이해가 먼저, 숫자는 곁들임): 자동 검증 시험 396개 전부 통과 ·
