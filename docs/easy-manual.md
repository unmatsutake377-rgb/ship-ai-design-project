...
> (마지막 갱신: 2026-08-05 — 14일차: 실선 밑부분·선수미 비대칭·적재 처방)
...
| ② 배 모양 생성 | ✅ 공식 3계열 + Ship-D 3만 척 선별 — **실선급 선저(용도별)·선수미 비대칭이 기본** |
